          ...
          <div class="carCount">
            ...
            >
              ...
              <div class="box-right">
                ...
                <div class="others">
                  <p :title="dataFilter(item.count)">{{ dataFilter(item.count) }}</p>
                  <!-- <p>......</p> -->
                  <!-- <div>
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      if (flag === 1) {
        ...
        // 报警车辆数
        carData.carList[0].count = pageTwo.obj.alarmVehicleNum;
        carData.carList[1].count = obj.expiredFourNum + obj.expiredTwoNum + obj.expiredOneNum + obj.expiredThreeNum;
