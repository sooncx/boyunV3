    ...
    <div class="header">
      <div class="header__top">
        <div class="header__top__left">
          ...
          <div class="item">
            <label>选择日期</label>
            <SelectDate v-model:value="rangeDate" :dateType="selectDateTypeEnum.DATE"></SelectDate>
          </div>
          <div class="item date">
            <label>即将到期</label>
            <SelectDate @selectDay="onExpireTime" :dateType="selectDateTypeEnum.DAY"></SelectDate>
          </div>
        </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    // 导出功能
    const onExpload = () => {
      API.vehicleFreeLogExport(data.search);
    }
    ...
    const getData = async () => {
      ...
      data.search.vid ='';
      if(data.fuzzyValue.vehicleId !== undefined) data.search.vid = data.fuzzyValue.vehicleId;
      try {
