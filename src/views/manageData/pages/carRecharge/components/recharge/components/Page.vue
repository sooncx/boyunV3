<template>
  <div class="page">
    <div class="page__left">
      <a-button type="primary" v-permission="160404" @click="batchRecharge" v-if="renew === renewEnum.YES">批量续费</a-button>
      <a-button type="primary" v-permission="160405" @click="batchIntoNoRecharge">批量转入不续费</a-button>
      <a-button type="primary" v-permission="160408" @click="customNoRecharge(customRechargeTypeEnum.CUSTOM_RECHARGE)">自定义续费</a-button>
      <a-button type="primary" v-permission="160406" @click="customNoRecharge(customRechargeTypeEnum.CUSTOM_NO_RECHARGE)">自定义不续费</a-button>
      <a-button type="primary" v-permission="160407" @click="customNoRecharge(customRechargeTypeEnum.CUSTOM_NO_RECHARGE_OUT)">自定义不续费转出</a-button>
    </div>
...
import { customRechargeTypeEnum,renewEnum } from '@/enums/manageDataEnum';
