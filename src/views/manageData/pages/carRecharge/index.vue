  ...
  <div class="content">
    ...
    <div class="content__body">
      <div class="content__body__tabs">
        ...
        v-for="(item,index) in tabsItem" :key="index">{{item.title}}</div>
      </div>
...
export default defineComponent({
  ...
  setup() {
    const data = reactive({
      ...
      tabsItem: [                                                   // 标签页数据
        { title: '车辆续费', value: 'carRecharge' },
        { title: '续费记录', value: 'rechargeLog' },
        { title: '车币划拨', value: 'carCoin'},
        { title: '车币划拨记录', value: 'carCoinLog'}
      ],
    });
