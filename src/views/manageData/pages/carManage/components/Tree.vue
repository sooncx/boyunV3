...
export default defineComponent({
  ...
  setup() {
    ...
    const getType = (type: string, item: any) => {
      if (type === treeSettingTypeEnum.DELETE) {
        Modal.confirm({
          title: "是否删除该车组？",
          content: createVNode(
            "div",
      ...
      if (type === treeSettingTypeEnum.ADD || type === treeSettingTypeEnum.EDIT) {
        data.carGroupModelType = type;
        data.modalVisible = true;
      }
      if (type === treeSettingTypeEnum.EDITINFO) {
