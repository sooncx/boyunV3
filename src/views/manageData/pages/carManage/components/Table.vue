    ...
    <div class="carTable detailTable" ref="tableBox">
      ...
      >
        ...
        <el-table-column prop="button" label="操作" align="center" width="150">
          <template #default="scope">
            <div class="setting">
              <span v-permission="160208" @click="moveCar(scope.row)">转移</span>
              <span v-permission="160209" @click="edit(scope.row)">修改</span>
              <span v-permission="160210" v-if="checkDeleteCar()" @click="deleteCar(scope.row)">删除</span>
