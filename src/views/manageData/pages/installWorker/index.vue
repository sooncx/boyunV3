  ...
  <div class="content">
    <div class="header">
      <div class="header__left">
        <a-button type="primary" v-permission="160702" @click="showData(null,'add')">新建人员</a-button>
        <a-button v-permission="160705" @click="deleteData(null)">批量删除</a-button>
      </div>
      <div class="header__right">
        <a-input v-model:value.trim="search.name" placeholder="请输入安装人员名称"></a-input>
        <SelectDate v-model:value="rangeDate" :dateType="selectDateTypeEnum.DATE" />
        <a-button v-permission="160701" type="primary" @click="onSearch">
      ...
      <div class="body__table detailTable" ref="tableBox">
        ...
        >
          ...
          <el-table-column align="center" prop="button" label="操作">
            <template #default="scope">
              <div class="setting">
                <span v-permission="160703" @click="showData(scope.row,'edit')">修改</span>
                <span v-permission="160704" @click="deleteData(scope.row);">删除</span>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
import { selectDateTypeEnum } from '@/enums/manageDataEnum'
