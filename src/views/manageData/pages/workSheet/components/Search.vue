<template>
  <div class="search">
    <div class="search__left">
      <div class="item">
        <a-button v-permission="160602" type="primary" @click="mode('add')">新建工单</a-button>
        <a-button v-permission="160605" type="primary" @click="mode('delete')">删除工单</a-button>
      </div>
    </div>
    <div class="search__right">
      ...
      <div class="item">
        <a-button v-permission="160601" type="primary" @click="onSearch">
          <template #icon><i class="iconfont icon icon-sousuo"></i></template>
          查询</a-button>
        <a-button v-permission="160606" @click="mode('export')">
