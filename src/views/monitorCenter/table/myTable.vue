  ...
  <div class="tableBox">
    <div class="optionBar">
      <div>
        ...
        <i
          class="iconfont"
          :class="{'icon-yinliang-guan': !voiceOpen, 'icon-yinliang':voiceOpen}"
          @click="voiceTaggle"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const data = reactive({
      ...
      tableData: [] as any,
      alarmShow: false,
      voiceOpen: localStorage.getItem("voiceOpen") == "true",
      alarmCheckAll: true,
      ...
      voiceTaggle() {
        data.voiceOpen = !data.voiceOpen;
        localStorage.setItem("voiceOpen", data.voiceOpen as any);
      },
      // 获取表格数据
      async getTableData() {
        const params = {
    ...
    nextTick(() => {
      ...
      const audioDom = document.querySelector("#audio") as any;
      audioDom.muted = true;
      setTimeout(() => {
