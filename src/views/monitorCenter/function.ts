...
export function useFunction() {
    ...
    async function AddPoint(pointData: any) {
        ...
        try {
            const { flag, msg } = await API.AddPoint(params);
            if (flag == 1) {
                return flag;
            } else {
                showAMsg(msg);
    ...
    async function addPath(areaData: any) {
        try {
            const { flag, msg, obj } = await API.addPath(areaData);
            if (flag == 1 && ![null, undefined].includes(obj)) {
                return obj;
            } else {
                showAMsg(msg);
    ...
    async function updatePath(areaData: any) {
        try {
            const { flag, msg } = await API.updatePath(areaData);
            if (flag == 1) {
                return flag;
            } else {
                showAMsg(msg);
    ...
    async function saveRoundFence(params: any) {
        try {
            const { flag, msg } = await API.saveRoundFence(params);
            if (flag == 1) {
    ...
    async function updateRoundFence(params: any) {
        try {
            const { flag, msg } = await API.updateRoundFence(params);
            if (flag == 1) {
    ...
    async function addTwoCharge(params: any) {
        try {
            const { flag, msg } = await API.addTwoCharge(params);
            if (flag == 1) {
                return flag;
            } else {
                showAMsg(msg);
    ...
    async function saveVehicle(params: any) {
        try {
            const { flag, msg } = await manageDataAPI.saveVehicle(params);
            if (flag == 1) {
                return flag;
            } else {
                showAMsg(msg);
    ...
    async function updateVehicle(params: any) {
        try {
            const { flag, msg } = await manageDataAPI.updateVehicle(params);
            if (flag == 1) {
                return flag;
            } else {
                showAMsg(msg);
    ...
    async function saveVehicleConcern(params: any) {
        try {
            const { flag, msg } = await API.saveVehicleConcern(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    async function listAdminRegionGroup(params: any) {
        try {
            const { flag, msg } = await API.listAdminRegionGroup(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    async function maintenanceSettings(params: any) {
        try {
            const { flag, msg } = await API.maintenanceSettings(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    async function insertInsuranceDate(params: any) {
        try {
            const { flag, msg } = await API.insertInsuranceDate(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    async function processAlarm(params: any) {
        try {
            const { flag, msg } = await API.processAlarm(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    // 查询录像资源列表
    async function queryResourceResponse(params: any) {
        try {
            const { flag, obj } = await API.queryResourceResponse(params);
            if (flag == 1 && ![null, undefined].includes(obj)) {
                return obj
            }
        } catch (error) {
    ...
    async function fileUpload(params: any) {
        try {
            const { flag, obj } = await API.fileUpload(params);
            if (flag == 1 && ![null, undefined].includes(obj)) {
                return obj
            }
        }
    ...
    // 实时视频控制请求
    async function realControlReq(params: any) {
        try {
            const { flag, msg } = await API.realControlReq(params);
            if (flag == 1) {
                return flag
            } else {
                showAMsg(msg);
    ...
    // 录像回放资源目录请求
    async function replayResourceReq(params: any) {
        try {
            const { flag, msg } = await API.replayResourceReq(params);
            if (flag == 1) {
                return { flag, msg }
            }
        }
    ...
    // 获取车辆图标类型
    async function getVehicleIconType(params: any) {
        try {
            const { flag, obj } = await API.getVehicleIconType(params);
            if (flag == 1 && ![null, undefined].includes(obj)) {
                return obj
            }
            return null;
