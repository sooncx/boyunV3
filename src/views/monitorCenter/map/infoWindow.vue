<template>
  <div class="infoWindow">
    ...
    <div class="content">
      <div class="content__items wordWrap">
        <div>
          速度: <span>{{ otherFormat(selectedVeh, "S", "km/h") }}</span>
        </div>
      </div>
      <div
        class="content__items wordWrap"
      ...
      <div
        class="content__items wordWrap"
        v-if="selectedVeh && selectedVeh.isAcc != undefined"
      >
        <div>
          ACC状态: <span>{{ selectedVeh.isAcc?"关":"开" }}</span>
        </div>
      </div>
      <div
        class="content__items wordWrap"
        v-if="selectedVeh && selectedVeh.oilIsNormal != undefined"
      >
        <div>
          断油电状态: <span>{{ selectedVeh.oilIsNormal?"断开":"正常" }}</span>
        </div>
      </div>
      <div
