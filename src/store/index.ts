...
export default createStore({
  state: {
    ...
    carIconType: localStorage.getItem("carIconType") ? JSON.parse(localStorage.getItem("carIconType") as any) : null,
  },
  mutations: {
    COMMIT_CARICONTYPE(state: any, val: any) {
      val ? localStorage.setItem("carIconType", JSON.stringify(val)) : localStorage.removeItem("carIconType");
      state.carIconType = val;
    },
