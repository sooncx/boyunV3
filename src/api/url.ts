...
const beforeUrl = {
  ...
  getPowerRiskNum: '/car/v1/api/powerRisk/getPowerRiskNum.json', // 获取电量近近七天的过期数量
  getPowerRiskData: '/car/v1/api/powerRisk/getPowerRiskData.json', // 获取电量近七天的过期数据
  ...
  getVehicleIconType: "/car/v1/api/vehicle/getVehicleIconType.json", // 查询车辆图标类型
  ...
  fileUpload: "/car/v1/video/cmd/fileUpload.json", // 根据指令获取视屏流

  // 资料管理
  pageSettleList: '/car/v1/api/settle/pageSettleList', // 结清车辆列表
  getSettleTotal: '/car/v1/api/settle/getSettleTotal', // 结清总数
  ...
  vehicleFreeLogExport: '/car/v1/api/renew/vehicleFreeLogExport.json', // 续费记录导出
  userRechargeLogExport: '/car/v1/api/renew/userRechargeLogExport.json', // 车币划拨记录导出
