...
*/
   ...
   */
    ...
    * 查询资源列表结果
    */
   queryResourceResponse: (params: any): Promise<any> => GET(url.queryResourceResponse, params),
   /**
    * 根据指令获取视屏流
    */
   fileUpload: (params: any): Promise<any> => POSTBody(url.fileUpload, params),
   /**
    * 获取车辆图标类型
    */
   getVehicleIconType: (params: any): Promise<any> => GET(url.getVehicleIconType, params),
}